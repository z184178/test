...
private slots:
    ...
    void onthreadA_newValue(int seq, int topoValue);
...
private:
    ...
    qint16 portn1 = 8881;//主控下发命令
    qint16 portn2 = 8882;//主控下发命令
    qint16 portn3 = 8883;//主控下发命令
    qint16 portn4 = 8884;//主控下发命令
    qint16 portg1 = 8885;//主控下发命令
    qint16 portg2 = 8886;//主控下发命令
    QVector<qint16> port;
